      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: AppTheme.spacingL),
            _buildTeamMember('Website Developer', 'Yves Jimenez'),
            const SizedBox(height: AppTheme.spacingS),
            _buildTeamMember('Nutrition Specialists', 'Lance Corpuz\nJezria Cara-an'),
            const SizedBox(height: AppTheme.spacingS),
            _buildTeamMember('Fitness Experts', 'Cyrra Vergara\nAllaine Panlilio\nAdeline Pepito'),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: AppTheme.spacingL),
            _buildContactItem(Icons.email, 'yves_alvin_jimenez@dlsu.edu.ph'),
            const SizedBox(height: AppTheme.spacingM),
            _buildContactItem(Icons.location_on, 'De La Salle University - Manila'),
            const SizedBox(height: AppTheme.spacingL),
            Container(
              padding: const EdgeInsets.all(AppTheme.spacingM),
              decoration: BoxDecoration(
